...
class lar_gen(object):
	...
	- make_row
	"""
	def __init__(self, lar_schema_file="2024/schemas/lar_schema.json", ts_schema_file="2024/schemas/ts_schema.json",for_frontend = False):
	...
	def make_ts_row(self, bank_file_config):
		...
		ts_row["calendar_quarter"] = int(bank_file_config["calendar_quarter"]["value"])
