...
class lar_gen(object):
	...
	def make_row(self, lar_file_config, geographic_data, state_codes, zip_code_list):
		...
		if self.for_frontend:
			...
			lar_row_str = f"2|{lei}|{uli}|{year}0113|3|2|2|2|3|218910|1|{actionTakenDate}|1234 Hocus Potato Way|Washington|DC|14755|{county}|{censusTract}|1|13||11||KE0NW|1||||||2|2|7||||||||27|24|41|43|2||||3|2|2|2|1|1|75|44|85|0|NA|3|2|8888|8888|9||9||10|||||NA|NA|NA|NA|NA|NA|NA|NA|NA|256|29|2|2|2|2|NA|1|2|4|NA|2|2|NA|3|1|5|1||DOREBESQSW1QT58SD2OZTHQUGXLSKCAJYZ63NJE2MUIAFQL4KW6PU26YSU786GT0IMCWWKCN25Y7KU0VLU0PPKWR8G6DKWI9BANPIE9I2ZZ5XDUX0TBAY4XFRFQZF087WS9ESTAKIV5V9HSZ2VXW7J5JMGPP4CGYA51BK68T57NN4KTKJVXIQMFXBTN5E3LGKKX3LITQ4C7OPFJ|8|6|5|5|||2|2|1"
			lar_row_values = lar_row_str.split(sep= "|")
			valid_lar_row = OrderedDict(zip(lar_schema_col_names, lar_row_values))      
		else:
